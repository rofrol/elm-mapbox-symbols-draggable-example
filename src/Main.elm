...
style : Style
style  =
    Style {transition = Style.defaultTransition
    , light = Style.defaultLight
    , layers = [(Layer.background "land" [(Layer.backgroundColor ((E.rgba 245 245 243 1)))])
    , (Layer.fill "landcover" "composite" [(Layer.sourceLayer "landcover")
    , (Layer.maxzoom 7)
    , (Layer.fillColor ((E.rgba 226 226 226 1)))
    , (Layer.fillOpacity ((((E.zoom)) |> (E.interpolate ((E.Exponential 1.5)) [(2, ((float 0.1)))
    , (7, ((float 0)))]))))
    , (Layer.fillAntialias (false))])
    , (Layer.fill "national-park" "composite" [(Layer.sourceLayer "landuse_overlay")
    , (Layer.minzoom 5)
    ...
    , (Layer.lineWidth ((((E.zoom)) |> (E.interpolate ((E.Exponential 1.5)) [(9, ((((E.getProperty ((str "type")))) |> (E.matchesStr [("runway", ((float 1)))
    , ("taxiway", ((float 0.5)))] ((float 0.5))))))
    , (18, ((((E.getProperty ((str "type")))) |> (E.matchesStr [("runway", ((float 80)))
    , ("taxiway", ((float 20)))] ((float 20))))))]))))
    , (Layer.lineColor ((E.rgba 247 247 247 1)))])
    , (Layer.line "building-outline" "composite" [(Layer.sourceLayer "building")
    , (Layer.minzoom 15)
    ...
    , (Layer.lineWidth ((((E.zoom)) |> (E.interpolate ((E.Exponential 1.5)) [(15, ((float 0.75)))
    , (20, ((float 3)))]))))
    , (Layer.lineOpacity ((((E.zoom)) |> (E.interpolate ((E.Linear)) [(15, ((float 0)))
    , (16, ((float 1)))]))))])
    , (Layer.fill "building" "composite" [(Layer.sourceLayer "building")
    , (Layer.minzoom 15)
    , (Layer.filter ((E.all ((((E.getProperty ((str "type")))) |> (E.notEqual ((str "building:part"))))) ((((E.getProperty ((str "underground")))) |> (E.isEqual ((str "false"))))))))
    , (Layer.fillOutlineColor ((E.rgba 222 222 220 1)))
    , (Layer.fillOpacity ((((E.zoom)) |> (E.interpolate ((E.Linear)) [(15, ((float 0)))
    , (16, ((float 1)))]))))
    , (Layer.fillColor ((E.rgba 233 233 230 1)))])
    , (Layer.line "tunnel-street-minor-low" "composite" [(Layer.metadata (((Debug.todo "The expression {"mapbox:group":"1444855769305.6016"} is not yet supported"))))
    ...
    , (Layer.lineCap (E.lineCapRound))
    , (Layer.lineJoin (E.lineCapRound))])
    , (Layer.line "tunnel-street-minor-case" "composite" [(Layer.metadata (((Debug.todo "The expression {"mapbox:group":"1444855769305.6016"} is not yet supported"))))
    , (Layer.sourceLayer "road")
    , (Layer.minzoom 13)
    , (Layer.filter ((E.all ((((E.getProperty ((str "structure")))) |> (E.isEqual ((str "tunnel"))))) ((((E.zoom)) |> (E.step (((Debug.todo "The expression ["match",["get","class"],["street","street_limited","track","primary_link"],true,false] is not yet supported"))) [(14, (((Debug.todo "The expression ["match",["get","class"],["street","street_limited","track","primary_link","secondary_link","tertiary_link","service"],true,false] is not yet supported"))))]))) ((((E.geometryType)) |> (E.isEqual ((str "LineString"))))))))
    ...
    , (Layer.lineCap (E.lineCapRound))
    , (Layer.lineJoin (E.lineCapRound))])
    , (Layer.line "tunnel-primary-secondary-tertiary-case" "composite" [(Layer.metadata (((Debug.todo "The expression {"mapbox:group":"1444855769305.6016"} is not yet supported"))))
    , (Layer.sourceLayer "road")
    , (Layer.minzoom 13)
    ...
    , (Layer.lineCap (E.lineCapRound))
    , (Layer.lineJoin (E.lineCapRound))])
    , (Layer.line "tunnel-major-link-case" "composite" [(Layer.metadata (((Debug.todo "The expression {"mapbox:group":"1444855769305.6016"} is not yet supported"))))
    , (Layer.sourceLayer "road")
    , (Layer.minzoom 13)
    ...
    , (Layer.lineCap (E.lineCapRound))
    , (Layer.lineJoin (E.lineCapRound))])
    , (Layer.line "tunnel-motorway-trunk-case" "composite" [(Layer.metadata (((Debug.todo "The expression {"mapbox:group":"1444855769305.6016"} is not yet supported"))))
    , (Layer.sourceLayer "road")
    , (Layer.minzoom 13)
    ...
    , (Layer.lineCap (E.lineCapRound))
    , (Layer.lineJoin (E.lineCapRound))])
    , (Layer.line "road-minor-case" "composite" [(Layer.metadata (((Debug.todo "The expression {"mapbox:group":"1444855786460.0557"} is not yet supported"))))
    , (Layer.sourceLayer "road")
    , (Layer.minzoom 13)
    , (Layer.filter ((E.all ((((E.zoom)) |> (E.step ((((E.getProperty ((str "class")))) |> (E.isEqual ((str "track"))))) [(14, (((Debug.todo "The expression ["match",["get","class"],["track","secondary_link","tertiary_link","service"],true,false] is not yet supported"))))]))) (((Debug.todo "The expression ["match",["get","structure"],["none","ford"],true,false] is not yet supported"))) ((((E.geometryType)) |> (E.isEqual ((str "LineString"))))))))
    , (Layer.lineWidth ((((E.zoom)) |> (E.interpolate ((E.Exponential 1.5)) [(12, ((float 0.75)))
    , (20, ((float 2)))]))))
    , (Layer.lineColor ((E.rgba 232 237 235 1)))
    , (Layer.lineGapWidth ((((E.zoom)) |> (E.interpolate ((E.Exponential 1.5)) [(14, ((((E.getProperty ((str "class")))) |> (E.matchesStr [("track", ((float 1)))] ((float 0.5))))))
    , (18, ((float 12)))]))))
    , (Layer.lineOpacity ((((E.zoom)) |> (E.step ((float 0)) [(14, ((float 1)))]))))
    , (Layer.lineCap (E.lineCapRound))
    , (Layer.lineJoin (E.lineCapRound))])
    , (Layer.line "road-street-case" "composite" [(Layer.metadata (((Debug.todo "The expression {"mapbox:group":"1444855786460.0557"} is not yet supported"))))
    , (Layer.sourceLayer "road")
    , (Layer.minzoom 11)
    , (Layer.filter ((E.all (((Debug.todo "The expression ["match",["get","class"],["street","street_limited","primary_link"],true,false] is not yet supported"))) (((Debug.todo "The expression ["match",["get","structure"],["none","ford"],true,false] is not yet supported"))) ((((E.geometryType)) |> (E.isEqual ((str "LineString"))))))))
    , (Layer.lineWidth ((((E.zoom)) |> (E.interpolate ((E.Exponential 1.5)) [(12, ((float 0.75)))
    ...
    , (Layer.lineCap (E.lineCapRound))
    , (Layer.lineJoin (E.lineCapRound))])
    , (Layer.line "road-secondary-tertiary-case" "composite" [(Layer.metadata (((Debug.todo "The expression {"mapbox:group":"1444855786460.0557"} is not yet supported"))))
    , (Layer.sourceLayer "road")
    ...
    , (Layer.lineWidth ((((E.zoom)) |> (E.interpolate ((E.Exponential 1.5)) [(10, ((float 0.75)))
    , (18, ((float 2)))]))))
    , (Layer.lineColor ((E.rgba 232 237 235 1)))
    , (Layer.lineGapWidth ((((E.zoom)) |> (E.interpolate ((E.Exponential 1.5)) [(5, ((float 0.1)))
    , (18, ((float 26)))]))))
    , (Layer.lineCap (E.lineCapRound))
    , (Layer.lineJoin (E.lineCapRound))])
    , (Layer.line "road-primary-case" "composite" [(Layer.metadata (((Debug.todo "The expression {"mapbox:group":"1444855786460.0557"} is not yet supported"))))
    , (Layer.sourceLayer "road")
    ...
    , (Layer.lineCap (E.lineCapRound))
    , (Layer.lineJoin (E.lineCapRound))])
    , (Layer.line "road-major-link-case" "composite" [(Layer.metadata (((Debug.todo "The expression {"mapbox:group":"1444855786460.0557"} is not yet supported"))))
    , (Layer.sourceLayer "road")
    , (Layer.minzoom 10)
